  ...
  return (
    <div className="bg-gray-50 min-h-screen py-12 sm:py-16 lg:py-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="flex items-center">
                ...
                <div className="ml-5">
                  ...
                  <p className="mt-2 text-base text-gray-700">
                    <a href="tel:+1-800-123-4567" className="hover:text-indigo-600 transition-colors">
                      +1 (800) 123-4567
                    </a>
                  </p>
            ...
            <div className="px-4 py-5 sm:p-6">
              <div className="flex items-center">
                ...
                <div className="ml-5">
                  ...
                  <p className="mt-2 text-base text-gray-700">
                    <a href="mailto:support@shopeasy.com" className="hover:text-indigo-600 transition-colors">
                      support@shopeasy.com
                    </a>
                  </p>
                  <p className="mt-1 text-sm text-gray-500">We'll respond as quickly as possible</p>
                </div>
              </div>
            </div>
          </motion.div>
            ...
            <div className="px-4 py-5 sm:p-6">
              <div className="flex items-center">
                ...
                <div className="ml-5">
                  ...
                  <p className="mt-2 text-base text-gray-700">
                    <a href="https://maps.google.com/?q=123+Commerce+Street,+Tech+City,+CA+90210" target="_blank" rel="noopener noreferrer" className="hover:text-indigo-600 transition-colors">
        ...
        <motion.div 
          className="mt-16 bg-white overflow-hidden shadow rounded-lg"
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ delay: 0.6, duration: 0.5 }}
        >
          <div className="px-4 py-5 sm:p-6">
            <h3 className="text-lg leading-6 font-medium text-gray-900 text-center mb-6">Connect With Us</h3>
        ...
        >
          ...
          <p className="text-gray-700 mb-4">
            Have more questions? Check out our FAQs page or contact us directly.
          </p>
          <Link 
            href="/faq" 
            className="inline-flex items-center px-4 py-2 border border-transparent text-base font-medium rounded-md shadow-sm text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition-all"
          >
            Visit FAQ Page
          </Link>
        </motion.div>
